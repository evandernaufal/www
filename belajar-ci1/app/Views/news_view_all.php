                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <a href="<?= base_url('admin/news/edit/'.$reading['id']); ?>" class="btn btn-success">Edit</a><br><br>
                                            <a href="<?= base_url('admin/news/delete/'.$reading['id']); ?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
